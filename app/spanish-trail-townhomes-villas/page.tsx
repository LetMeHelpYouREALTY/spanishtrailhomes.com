...
const webPageSchema = createWebPageSchema({
  ...
  path: '/spanish-trail-townhomes-villas',
...
export default function SpanishTrailTownhomesVillasPage() {
  return (
    <SiteShell>
      <HeroSection />
      <BackPageOverview headingId="townhomes-overview-heading" {...TOPIC_OVERVIEWS.townhomes} />
      <RealScoutSection
        id="bhhs-listings"
      ...
      <Script id="spanish-trail-townhomes-villas-webpage-schema" type="application/ld+json">
