  ...
  return (
    <section className="bg-[#f8f2e7] py-16 sm:py-20" aria-labelledby="custom-estate-cta-heading">
      <div className="mx-auto max-w-6xl px-6 text-center">
        ...
        <p className="mt-4 text-base leading-relaxed text-[#372a20]/85">
          Call <Link href="tel:17025001955" className="underline-offset-4 hover:underline">702-500-1955</Link>, text 702-222-1964, or email <Link href="mailto:jduffy@bhhsnv.com" className="underline-offset-4 hover:underline">jduffy@bhhsnv.com</Link>. I’ll assemble a private tour schedule, vendor introductions, and security brief tailored to your move date.
        </p>
