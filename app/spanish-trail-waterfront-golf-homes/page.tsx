...
const webPageSchema = createWebPageSchema({
  ...
  path: '/spanish-trail-waterfront-golf-homes',
...
export default function WaterfrontGolfHomesPage() {
  return (
    <SiteShell>
      <HeroSection />
      <BackPageOverview headingId="waterfront-overview-heading" {...TOPIC_OVERVIEWS.waterfront} />
      <RealScoutSection
        id="bhhs-listings"
      ...
      <Script id="spanish-trail-waterfront-golf-homes-webpage-schema" type="application/ld+json">
...
function HeroSection() {
  return (
    <section className="bg-[#0f2b1e] py-16 text-[#f8f5ef] sm:py-20 relative isolate overflow-hidden hero-photo-copy" aria-labelledby="waterfront-hero-heading">
