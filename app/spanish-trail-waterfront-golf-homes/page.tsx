  ...
  return (
    <section className="bg-[#f8f2e7] py-16 sm:py-20" aria-labelledby="waterfront-cta-heading">
      <div className="mx-auto max-w-6xl px-6 text-center">
        ...
        <p className="mt-4 text-base leading-relaxed text-[#372a20]/85">
          Contact <Link href="tel:17025001955" className="underline-offset-4 hover:underline">702-500-1955</Link> or email <Link href="mailto:jduffy@bhhsnv.com" className="underline-offset-4 hover:underline">jduffy@bhhsnv.com</Link>. I’ll deliver a custom shortlist, arrange view-focused tours, and guide you through every step.</p>
