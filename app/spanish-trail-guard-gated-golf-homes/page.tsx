  ...
  return (
    <section className="bg-[#f8f2e7] py-16 sm:py-20" aria-labelledby="guard-gated-contact-heading">
      <div className="mx-auto max-w-6xl px-6 text-center">
        ...
        <p className="mt-4 text-base leading-relaxed text-[#372a20]/85">
          Reach Dr. Jan Duffy directly at <Link href="tel:17025001955" className="underline-offset-4 hover:underline">702-500-1955</Link> or text 702-222-1964. Request a guard-gated tour itinerary, golf pairing, or membership briefing tailored to your moving timeline.
        </p>
