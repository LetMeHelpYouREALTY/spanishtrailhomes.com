...
const webPageSchema = createWebPageSchema({
  ...
  path: '/spanish-trail-guard-gated-golf-homes',
...
export default function GuardGatedGolfHomesPage() {
  return (
    <SiteShell>
      <HeroSection />
      <BackPageOverview headingId="guard-gated-overview-heading" {...TOPIC_OVERVIEWS['guard-gated']} />
      <RealScoutSection
        id="bhhs-listings"
      ...
      <Script id="spanish-trail-guard-gated-golf-homes-webpage-schema" type="application/ld+json">
...
function HeroSection() {
  return (
    <section className="bg-[#0f2b1e] py-16 text-[#f8f5ef] sm:py-20 relative isolate overflow-hidden hero-photo-copy" aria-labelledby="guard-gated-hero-heading">
