...
export default function SouthwestLasVegasLuxuryHomesPage() {
  return (
    <SiteShell>
      ...
      <Script id="spanish-trail-southwest-las-vegas-luxury-homes-webpage-schema" type="application/ld+json">
...
function HeroSection() {
  return (
    <section className="bg-[#0f2b1e] py-16 text-[#f8f5ef] sm:py-20 relative isolate overflow-hidden hero-photo-copy" aria-labelledby="southwest-hero-heading">
