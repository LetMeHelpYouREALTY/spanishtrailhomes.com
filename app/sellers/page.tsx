    ...
    <section id="seller-valuation-widget" className="bg-white py-16 sm:py-20" aria-labelledby="home-value-heading">
      <div className="mx-auto max-w-3xl space-y-6 px-6 text-center">
        ...
        <p className="text-base leading-relaxed text-[#372a20]/85">
          RealScout’s valuation engine pulls live MLS comps, private sales, and buyer demand signals specific to Spanish Trail’s eleven guard-gated enclaves. Enter your address, confirm home details, and you’ll receive a dynamic range updated as new listings appear or close. I immediately review your submission, overlay hyperlocal insights—club membership status, renovation scope, Strip or golf frontage—and share a custom equity roadmap within 24 hours.
        </p>
        <p className="text-base leading-relaxed text-[#372a20]/85">
    ...
    <section className="bg-[#f8f2e7] py-16 sm:py-20" aria-labelledby="market-confidence-heading">
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-12 px-6 lg:grid-cols-[1.1fr_1fr]">
        <div className="space-y-6">
          ...
          <p className="text-base leading-relaxed text-[#372a20]/85">
            Limited new construction behind guard gates, a thriving medical and legal professional base, and elevated demand for dual primary homes are converging to keep Spanish Trail inventory tight. Villas and townhomes have fewer than sixty days of supply, while custom estates strip-view demand is fueled by corporate relocations and private wealth migration from California, Arizona, and Texas. We use weekly absorption metrics, price-per-square-foot trends, and RealScout buyer alerts to gauge when to launch, when to drip pre-market teasers, and when to hold firm during negotiation.
          </p>
          <p className="text-base leading-relaxed text-[#372a20]/85">
